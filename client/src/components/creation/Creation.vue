<template>
  <div class="content">
    ...
    <el-input type="text" v-model="title" placeholder="请输入标题" maxlength="20" show-word-limit minlength="1"
              style="margin-bottom: 5px"></el-input>
    <el-input type="textarea" v-model="intor" placeholder="请输入简介" maxlength="50" show-word-limit
              minlength="9"></el-input>
