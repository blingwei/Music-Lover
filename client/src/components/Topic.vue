        ...
        <div class="info">
            <el-row :gutter="5" style="margin-top: 20px">
                ...
                <el-col :span="16">
                    ...
                    <div style="margin-top: 20px; font-size: 10px; color: #969696"><span>{{topicInfo.productionNum}}作品 </span></div>
                </el-col>
            ...
            <el-dialog :visible.sync="dialogVisible" style="width: 60%; margin-left: 20%" @close="checkList = []">
                ...
                <div class="myPublish" >
                    <el-checkbox-group v-model="checkList">
                        <div style="width: 60%; height: 20px" v-for="(item,index) in myPublishList.filter(data => !search || data.title.toLowerCase().includes(search.toLowerCase()))" :key="index">
...
<script>
    export default {
        ...
        data() {
            return {
                topic: this.$store.state.topicId,
                topicInfo:{
                    name: "",
                    introduce: "",
